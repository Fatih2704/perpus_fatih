...
<head>
  ...
  <link rel="website icon" type="png" href="images/a.png">
</head>
...
<body>
  <div class="header_section">
    <div class="container-fluid">
      <n class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#page"><img src="images/s.png"></a>
    </div>
  </div>
  </div>
  <!-- header section end -->
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <div class="banner_taital_main">
                  <h1 class="banner_taital line1">Selamat Datang di</h1>
                  <h1 class="banner_taital line2">Perpustakaan Lentera Budaya</h1>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-6">
          ...
          <div class="footer_menu">
            <ul>
              <p class="dummy_text">Jl. Margonda No.8, Pondok Cina, Kecamatan Beji, Kota Depok, Jawa Barat 16424</p>
              <li class="active"><a href="https://www.google.com/maps?gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQABiABDIKCAIQABiABBiiBDIHCAMQABjvBTIKCAQQABiABBiiBDIKCAUQABiABBiiBDIKCAYQABiABBiiBNIBCDI4MTZqMGo3qAIAsAIA&um=1&ie=UTF-8&fb=1&gl=id&sa=X&geocode=KXXt31M87GkuMV5d_Iala1-t&daddr=Jl.+Margonda+No.8,+Pondok+Cina,+Kecamatan+Beji,+Kota+Depok,+Jawa+Barat+16424" target="_blank"><span class="angle_icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-map" viewBox="0 0 16 16">
        ...
        <div class="col-lg-4 col-sm-6">
          ...
          <div class="social_icon">
            <ul>
              <li><a href="https://api.whatsapp.com/send/?phone=%2B6289528507746&text&type=phone_number&app_absent=0" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
              ...
              <li><a href="https://www.instagram.com/bsimargonda/?hl=id" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-4 col-sm-2">
          <div class="footer_main">
            <h3 class="footer_text">Email</h3>
            <p class="dummy_text">info@bsi.ac.id</p>
  ...
  <div class="copyright_section">
    <div class="container">
      <p class="copyright_text">2025 All Rights Reserved. Design by <a href="#">perpus.com</a></p>
    </div>
  </div>
