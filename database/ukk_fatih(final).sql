...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Feb 2024 pada 15.13
...
(212210154, 'fatih', '123', 'XII', 'Rekayasa Perangkat Lunak', 'Depok');
...
--
ALTER TABLE `member`
  MODIFY `nisn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=212210155;
